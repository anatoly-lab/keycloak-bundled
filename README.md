...
| Arg | Default | Purpose |
| --- | --- | --- |
| `KC_VERSION` | `26.7.2` | Keycloak base image tag. Must match the Keycloak Operator version deployed by the consuming Kubernetes manifest. |
